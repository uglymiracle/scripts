...
huvec <- readRDS(paste0(WORKDIR, use.name, 'fibr.huvec.rds'))
pericytes <- readRDS(paste0(WORKDIR, use.name, 'fibr.pericytes.rds'))
fibroblasts <- readRDS(paste0(WORKDIR, use.name, 'fibr.fibroblasts.rds'))
```
...
```{r}
wp <- getGeneSets(library = "C2", subcategory = 'CP:WIKIPATHWAYS')
